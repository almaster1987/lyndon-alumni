...
>
> **▶ QC was completed 2026-06-04 — results in `docs/QC-HANDOFF.md`.** Site passed (40+ links + all 21 images verified live, every anchor resolves, zero 404s). One fix applied: removed a dead footer "Council Dashboard" link. Two human-only checks remain (Blackbaud fund label, FB group); pending-content placeholders unchanged.
